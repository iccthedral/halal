...
define ["halalentity", "renderer", "camera", "matrix3", "quadtree", "vec2", "geometry"],

(HalalEntity, Renderer, Camera, Matrix3, QuadTree, Vec2, Geometry) ->
    ...
    class Scene extends HalalEntity
        constructor: (meta = {}) ->
            ...
            @_identity_update = true

        # resetQuadSpace: (dim) ->
        #     llogd "QuadSpace reset"
        #     @quadspace = null
        ...
        #         llogw "Couldn't add entity #{ent.id} to quadspace"
        #     return ent
        ...
        drawStat: () ->
            ...
            Hal.glass.ctx.fillText("Num of free pool vectors: #{Vec2.free}", 0, 70)
        ...
        #     )
            ...
            #     #find enclosing camera quadspace 


            #     #find overlapping/contained quadspaces within the selected enclosing quadspace

            #     corner = @worldToLocal([0,0])
            #     rect = [corner[0], corner[1], @camera.w / @camera.zoom, @camera.h / @camera.zoom]

            #     for ent in @entities
            #         bbox = [ent.x + ent.bbox[2], ent.y + 32, ent.bbox[2], ent.bbox[3]]
            #         ent.needs_updating = true
            #         ent.update()

            #         if Hal.math.isRectInRect(bbox, rect)
        ...
        init: () ->
            ...
            #         llogd "i'm out of my quadspace #{ent.id}"
