(function() {
  ...
  require(["loglevel"], function(log) {
    window.log = log;
    return require(["Halal", "Scene", "Entity", "SpriteEntity", "IsometricMap"], function(Halal, Scene, Entity, SpriteEntity, IsometricMap) {
      ...
      */
      ...
      return Hal.asm.on("SPRITES_LOADED", function() {
        ...
        Hal.debug(true);
        return require(["MapEditor", "HudProlog"], function(MapEditor, HudProlog) {
          return log.debug("MapEditor loaded");
        });
      });
    });
  });
