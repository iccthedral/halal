    ...
    */
    ...
    addTileToTilesDialog = function(t, wrapper) {
      wrapper.click(function() {
        ...
        return Hal.trigger("TILE_LAYER_SELECTED", wrapper.data("tile"));
      });
